...
var StandardRenderer = function ( webglRenderer, teapots, dispParams ) {
	...
	var tex = new THREE.TextureLoader().load( 'https://i.imgur.com/ulhhuE6.png' );
    var planeMaterial = new THREE.MeshBasicMaterial( {map: tex, transparent: true, opacity: 0.99, side: THREE.DoubleSide } );

	var planeGeometry = new THREE.PlaneGeometry( 1000, 1000, 100, 100 );

	var plane = new THREE.Mesh( planeGeometry, planeMaterial );

	plane.position.set( 0, 0, -1000.0 );
