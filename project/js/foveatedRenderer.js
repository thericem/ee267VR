...
var FoveatedRenderer = function ( webglRenderer, dispParams ) {
	...
	// Giberish to throw an error and show a black screen
	camera
	...
	var e1 = computeEcc( 2*pixelVA*4/* TODO (2.2.3) */ );

	// Eccentricity angle at which a 8x loss in resolution is imperceivable
	var e2 = computeEcc( 2*pixelVA*8/* TODO (2.2.3) */ );
	...
	function computePixelVA( pixelPitch, distanceScreenViewer ) {
		...
		var VA = 180/Math.PI*2.0*Math.atan2(pixelPitch,2.0*distanceScreenViewer);
